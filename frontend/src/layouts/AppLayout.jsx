...
function AppLayout() {
  ...
  if (isDashboardListView) {
    return (
      <div className="h-screen flex flex-col bg-[var(--bg-base)] overflow-hidden text-[var(--text-primary)]">
        <AppHeader />
  ...
  return (
    <div className="h-screen flex flex-row bg-[var(--bg-base)] text-[var(--text-primary)] overflow-hidden">
      <Sidebar />
